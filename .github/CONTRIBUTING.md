...
- Star the [project](https://github.com/multi-cell/devise-tergo.git)
...
- **Version**: please note the version of devise are you using
- **Extensions, plugins, helpers, etc** (if applicable): please list any extensions you're using
- **Error messages**: please paste any error messages into the issue, or a [gist](https://gist.github.com/)

### Closing issues

The original poster or the maintainer's of Devise may close an issue at any time. Typically, but not exclusively, issues are closed when:
